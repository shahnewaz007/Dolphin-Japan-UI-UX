...
import {
  Menu, ChevronDown, ChevronRight, LogOut,
        ...
        <nav style={{ flex: 1, overflowY: "auto", padding: "12px 8px" }}>
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <div key={item.key}>
                <button
                  onClick={() => collapsed ? setCollapsed(false) : toggle(item.key)}
                  title={collapsed ? item.label : undefined}
                  style={{
                    width: "100%",
                    display: "flex",
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, minWidth: 0 }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 700, color: colors.text, margin: 0, letterSpacing: "-0.01em", whiteSpace: "nowrap" }}>
              {pageTitle}
            </p>
          </div>
        ...
        {/* Content */}
        <main style={{ flex: 1, overflowY: "auto", padding: "24px 28px", background: colors.bg }}>
          <Outlet />
        </main>
      </div>
    </div>
